...
export default function PrepSencha() {


    return (
        <div className="flex flex-col justify-center gap-10 items-center">
            <div className="flex flex-col gap-5 pb-10 border-b-2 mt-10 font-kreon w-full">
                <h3 className="text-3xl text-yellow-600">Verdant fragrance and energetic flavour</h3>
                <p className="text-xl">Its tender characteristics come from the freshly picked tea buds.<br />
                    Brew for slightly less time than usual.</p>
                <p className="text-xl">Tip: Shincha 2024, brew for slightly longer, for 50 seconds. A 40-second brew (the recipe printed on the Shincha package) will produce a lighter taste.</p>
            </div>
            <div className="mt-10">
                <div className="pb-20">

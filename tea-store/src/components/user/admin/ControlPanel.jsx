    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-4 items-center gap-5  p-5 text-2xl font-kreon">
                <Link to={'/admin/teas'}>
                    <div className="flex flex-col justify-center items-center gap-5 border-2 rounded-3xl hover:scale-105 hover:bg-slate-50">
                        <div>
                ...
                <Link to={'/admin/users'}>
                    <div className="flex flex-col justify-center items-center gap-5 border-2 rounded-3xl hover:scale-105  hover:border-black">
                        <div>
